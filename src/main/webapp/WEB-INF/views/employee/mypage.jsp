...
<body>
	...
	<section class="wrap_left content">
		...
		<nav class=" right content_right">
			<table>
				<div>
				ID: ${sessionScope.user.employee_id}
				FirstName: ${user.first_name}
				LastName: ${user.last_name}
				LastName: ${requestScope.user.email}
				LastName: ${requestScope.user.phone_number}
				LastName: ${requestScope.user.hire_date}
				LastName: ${requestScope.user.job_id}
				LastName: ${requestScope.user.salary}
				
				</div>
				
				<div>
					<a href = "./update.do?employee_id=${user.employee_id}">정보수정</a>
				</div>
				<thead>
					<tr>
						<th>부서번호</th>
