...
public class EmployeeDAO {
	...
	public EmployeeDTO getList(EmployeeDTO employeeDTO) throws Exception {
		...
		if(resultSet.next()) {
			...
			result.setEmployee_id(resultSet.getInt(1));
			result.setFirst_name(resultSet.getString(2));
			result.setLast_name(resultSet.getString(3));
			result.setEmail(resultSet.getString(4));
			result.setPhone_number(resultSet.getString(5));
			result.setHire_date(resultSet.getDate(6));
			result.setJob_id(resultSet.getString(7));
			result.setSalary(resultSet.getInt(8));
			result.setCommision(resultSet.getInt(9));
			result.setManager_id(resultSet.getInt(10));
			result.setDepartment_id(resultSet.getInt(11));
...
//		statement.setString(11, employeeDTO.getPassword());
		statement.setInt(3, employeeDTO.getEmployee_id());
